        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Newbreed Events</p>
        ...
        <div class="row">
         ...
         <div class="influence-profile-content pills-regular">
            <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-campaign-tab" data-toggle="pill" href="#pills-campaign" role="tab" aria-controls="pills-campaign" aria-selected="true">View All Events</a>
                </li>
                <li class="nav-item">
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                        <a href = "/events/{{$event->id}}/edit"><img src="../storage/pictures/{{$event->picture}}" alt="user" class="rounded" width="100%"></a>
                                                        </div>
                                                    </div>
