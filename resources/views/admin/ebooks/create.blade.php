            ...
            <!-- <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"> -->
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-campaign" role="tabpanel" aria-labelledby="pills-campaign-tab">
                        <div class="card">
                            <h5 class="card-header">All E-Books Posts <strong>Click Image to Edit Post</strong></h5>
                            <div class="card-body">
                                <div class="row">
                                    @if(count($ebooks) > 0)
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                        <a href = "/ebooks/{{$post->id}}/edit"><img src="../storage/pictures/{{$post->picture}}" alt="user" class="rounded" width="100%"></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-footer text-center bg-white">
                                                        <div id="sparkline-1"><h3><a href="/storage/ebooks/{{$post->document}}" target="_blank">View PDF</a></h3></div>
                                                        {!!Form::open(['action'=>['EbooksController@destroy', $post->id], 'method'=> 'POST'])!!}
                    ...
                    <div class="tab-pane fade" id="pills-packages" role="tabpanel" aria-labelledby="pills-packages-tab">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Create New E-Books Post</h5>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="custom-file mb-3">
                                                    ...
                                                    <br/>
                                                    <label class="custom-file-label" for="customFile">Select E-book File</label>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
