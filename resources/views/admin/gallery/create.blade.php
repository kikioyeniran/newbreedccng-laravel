            ...
            <!-- <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"> -->
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-campaign" role="tabpanel" aria-labelledby="pills-campaign-tab">
                        <div class="card">
                            <h5 class="card-header">All Pictures</h5>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        @foreach($galleries as $gallery)
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div>
                                                        <a href = "#"><img src="../storage/pictures/{{$gallery->picture}}" alt="user" class="rounded" width="100%"></a>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer text-center bg-white">
                                                        {!!Form::open(['action'=>['GalleryController@destroy', $gallery->id], 'method'=> 'POST'])!!}
                                                            {{Form::hidden('_method', 'DELETE')}}
                                                            {{Form::submit('Delete event', ['class' => 'btn btn-danger', "onclick" => "return confirm('Are you sure you want to delete this picture?');"])}}
                                                        {!!Form::close()!!}
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-packages" role="tabpanel" aria-labelledby="pills-packages-tab">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Add New Pictures</h5>
                                <div class="card-body">
                                    {!! Form::open(['action' => 'GalleryController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                        <div class="row">
                                            <div class="custom-file mb-3">
                                                {{Form::file('picture[]', ['class'=> 'custom-file-input', 'multiple'])}}
                                                <br/>
